...
class DetailCountryView: UIView {
    ...
    private func setupNavigationBar() {
        ...
        viewController.setupNavigationBar(withTitle: "Country Detail")
    }
    ...
    @objc private func openGoogleMaps() {
        guard let viewModel = viewModel,
              let url = viewModel.openStreetMapsURL,
              let viewController = self.firstAvailableUIViewController else {
            return
        }
    ...
    @objc private func openOpenStreetMaps() {
        guard let viewModel = viewModel,
              let url = viewModel.googleMapsURL,
              let viewController = self.firstAvailableUIViewController else {
            return
        }
